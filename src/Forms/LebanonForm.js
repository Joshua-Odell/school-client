...
export default class LebanonForm extends React.Component {
	state = {
		startDate: new Date(),
	};
			...
			<form onSubmit={this.context.handleSubmit}>
					...
					<div id="basicInfo" className="item">
						<div className="spacing">
							...
							<input
								...
								onChange={this.context.stateUpdate('submissionEmail')}
							/>
						</div>
						<div className="spacing">
							...
							<input
								...
								onChange={this.context.stateUpdate('staff_submitter')}
							/>
						</div>
						<div className="spacing">
							...
							<input
								...
								onChange={this.context.stateUpdate('student_Last_Name')}
							/>
						</div>
						<div className="spacing">
							...
							<input
								...
								id="marssNumber"
								name="marssNumber"
								onChange={this.context.stateUpdate('student_marss')}
							/>
						</div>
						<div className="spacing">
					...
					<div id="involvedPeopleGroup" className="item">
						<div className="spacing">
							...
							<input
								...
								id="involvedPeople"
								name="involvedPeople"
								onChange={this.context.stateUpdate('people_involved')}
							/>
							<button
								type="button"
								onClick={() => {
				...
				<div className="container" id="multipleList">
					<div id="problemBehavior" className="item">
						{this.context.Select(
							...
							this.context.stateUpdate('behavior_type', true),
							true
						)}
					</div>
					<div className="item">
						...
						<select
							...
							multiple
							onChange={this.context.stateUpdate('major_disruption', true)}
						>
							<option value="Clearing Classroom">Clearing Classroom</option>
							<option value="Physical Aggression/Fighting">
								Physical Aggression/Fighting
							</option>
							<option value="Closing Hallway">Closing Hallway</option>
							<option value="Elopement from school property">
								Elopement from school property
							</option>
							<option value="Law Enforcment">Law Enforcment</option>
							<option value="Major Property Destruction">
					...
					<div className="item">
						{this.context.Select(
							list.concordRoomLocation,
							'Location',
							this.context.stateUpdate('room_location')
						)}
					</div>
				</div>
				<div id="expandedTextArea">
					<div>
						...
						<textarea
							...
							rows="10"
							cols="30"
							onChange={this.context.stateUpdate('narrative')}
							placeholder="this might include getting no sleep, hunger, new staff, new peer, 
                        events earlier in the day, etc. – anything that may have impacted the student's behavior"
						></textarea>
					</div>
					<div>
						<label htmlFor="contributingVariables">
							Contributing Variables:
						</label>
						<textarea
							name="contributingVariables"
							id="contributingVariables"
							rows="10"
							cols="30"
							onChange={this.context.stateUpdate('contributing_variables')}
							placeholder="this might include getting no sleep, hunger, new staff, new peer, 
                        events earlier in the day, etc. – anything that may have impacted the student's behavior"
						></textarea>
					</div>
					<div>
						...
						<textarea
							...
							rows="10"
							cols="30"
							onChange={this.context.stateUpdate('antecedent')}
				...
				<div className="container" id="holdsSection">
					<div className="item" id="holdInput">
						<div>
							<button type="button" onClick={this.context.createHoldIncident}>
								Add Hold
							</button>
						</div>
						<div id="holdEntry" hidden>
							<div>
								{this.context.Select(
									list.holds,
									'Hold',
									this.context.stateUpdate('holds_used')
								)}
								<label htmlFor="startTime">Start Time</label>
								<input
									type="time"
									id="regular-startTime"
									name="startTime"
									onChange={this.context.stateUpdate('start_time')}
								/>
								...
								<input
									...
									id="regular-stopTime"
									name="stopTime"
									onChange={this.context.stateUpdate('stop_time')}
								/>
								<div id="optionalSeconds">
									<label htmlFor="seconds">
										If time is less than 1 minute enter seconds:
									</label>
									<input
										type="text"
										id="regular-seconds"
										onChange={this.context.stateUpdate('seconds')}
									/>
								</div>
							</div>
							<div>
						...
						<div>
							...
							<select
								id="seclusion"
								name="seclusion"
								onChange={this.context.boolConversion('seclusion')}
							>
								<option value="---">---</option>
						...
						<div>
							...
							<select
								id="force"
								name="force"
								onChange={this.context.stateUpdate('reasonable_force')}
							>
								<option value="---">---</option>
								<option value="None">None</option>
								<option value="Non-PCM Hold">Non-PCM Hold</option>
								<option value="Unlicensed Seclusion">
									Unlicensed Seclusion
								</option>
							</select>
				...
				<div id="boolQuestions">
					<div>
						...
						<select
							id="administration"
							name="administration"
							onChange={this.context.boolConversion('administration')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
					...
					<div>
						<label htmlFor="parent">
							Parent/guardian contacted immediately following procedure
						</label>
						<select
							id="parent"
							name="parent"
							onChange={this.context.boolConversion('parent')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
						...
						<div>
							...
							<input
								...
								id="parent_time"
								name="parent_time"
								onChange={this.context.stateUpdate('parent_notification_time')}
							/>
					...
					<div>
						<label htmlFor="parent_problem_solving">
							Engaged the parent in problem solving
						</label>
						<select
							id="parent_problem_solving"
							name="parent_problem_solving"
							onChange={this.context.boolConversion('parent_problem_solving')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
					...
					<div>
						<label htmlFor="parent_right">
							Informed parent of right to call for an informal or formal meeting
							to further discuss the incident and their child's program
						</label>
						<select
							id="parent_right"
							name="parent_right"
							onChange={this.context.boolConversion('parent_right')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
					...
					<div>
						<label htmlFor="iep_meeting">
							IEP meeting called to review the adequacy of the IEP (Required if
							this is the second emergency use of restraint or seclusion in 30
							days and not already documented in the IEP.)
						</label>
						<select
							id="iep_meeting"
							name="iep_meeting"
							onChange={this.context.boolConversion('iep_meeting')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
					...
					<div>
						<label htmlFor="student_debriefing">
							Debriefing with other students
						</label>
						<select
							id="student_debriefing"
							name="student_debriefing"
							onChange={this.context.boolConversion('student_debriefing')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
					...
					<div>
						...
						<select
							id="staff_debriefing"
							name="staff_debriefing"
							onChange={this.context.boolConversion('staff_debriefing')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
					...
					<div>
						<label htmlFor="studentInjury">
							Student injury during restrictive procedure
						</label>
						<select
							id="studentInjury"
							name="studentInjury"
							onChange={this.context.boolConversion('student_injury')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
					...
					<div>
						<label htmlFor="staffInjury">
							Staff injury during restrictive procedure
						</label>
						<select
							id="staffInjury"
							name="staffInjury"
							onChange={this.context.boolConversion('staff_injury')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
					...
					<div>
						...
						<select
							id="lawenforcement"
							name="lawenforcement"
							onChange={this.context.boolConversion('law_enforcement')}
						>
							<option value="---">---</option>
							<option value="false">No</option>
							<option value="true">Yes</option>
